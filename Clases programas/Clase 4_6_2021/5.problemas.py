...
- Quien es la persona con la mayor edad
'''
...
def buscar_persona_mayor(nombres, edades):
    pos_mayor_edad = 0
    for i in range(len(edades)):
        if edades[pos_mayor_edad] < edades[i]:
            pos_mayor_edad = i
    
    nombre_mayor = nombres[pos_mayor_edad]
    return nombre_mayor
...
nombre_mayor = buscar_persona_mayor(nombres, edades)
print(f'La persona mayor es {nombre_mayor}')
